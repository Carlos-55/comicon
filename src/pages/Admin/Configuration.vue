            ...
            <!-- <q-dialog v-model="card"> -->
             <q-avatar size="130px">
              ...
              <!-- </q-dialog> -->
                ...
                <q-btn flat rounded  @click="open('bottom')" ><q-icon name="camera_alt" @click="uploadAuto(autState.userLogged)"/></q-btn>
